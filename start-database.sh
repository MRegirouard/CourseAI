...
DB_CONTAINER_NAME="course_ai-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=course_ai -d -p 5432:5432 docker.io/postgres
